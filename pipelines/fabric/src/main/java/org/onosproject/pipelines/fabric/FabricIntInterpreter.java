...
public class FabricIntInterpreter extends FabricInterpreter{
    private static final ImmutableBiMap<Integer, PiTableId> TABLE_ID_MAP =
            ...
            // Id starting from 100, to avoid possible overlapping with fabric table id map in the future
                    .put(100, FabricIntConstants.TBL_SET_SOURCE_SINK_ID)
                    .put(101, FabricIntConstants.TBL_INT_INSERT_ID)
                    .put(102, FabricIntConstants.TBL_INT_INST_0003_ID)
                    .put(103, FabricIntConstants.TBL_INT_INST_0407_ID)
                    .put(104, FabricIntConstants.TBL_INT_INST_1215_ID)
                    .put(105, FabricIntConstants.TBL_INT_SOURCE_ID)
                    .build();
